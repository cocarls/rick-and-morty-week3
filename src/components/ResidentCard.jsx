  ...
  return (
    <div className="border-solid border-2 border-green-500">
       ...
       <div className=" border-t-4 border-green-500">
          ...
          <ul className="p-2">
            <li><span className="font-serif text-[#938686]">species</span> {resident?.species}</li>
            <li><span className="font-serif text-[#938686]">Origin</span> {resident?.origin.name}</li>
            <li><span className="font-serif text-[#938686]" >times appear</span> {resident?.episode.length}</li>
          </ul>
       </div>
    </div>
  )
